        ...
        <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-2 order-1 sm:order-2">
            ...
            <a
              ...
              className="py-2 px-4 bg-[#0077b5] border-2 border-[#0077b5] text-white rounded-lg text-sm font-medium hover:bg-[#006396] hover:border-[#006396] transition-colors flex items-center justify-center gap-1 shadow-md opacity-100 hover:opacity-145"
            >
              LinkedIn
              <svg
