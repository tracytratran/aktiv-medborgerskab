          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600">
                {t("results.reviewSubtitle", { count: incorrectAnswers.length })}
              </p>
            </div>
            <button
            ...
            >
              <span>←</span> {t("results.backToResults")}
            </button>
          </div>
